...
George_dice <- c(3,1,5,7,6,1)
Maxwell_dice <- c(6,1,3,4,6,1)
Shaun_dice <- c(2,1,4,2,2,5)

dice_vector <- c(George_dice, Maxwell_dice, Shaun_dice)
...
Player_name <- c("Kuldeep","Ashwin","Gill")
Total_runs <- c(1300,1600,4000)
...
Player_age <- c(26,23,39)
hit_six <- c(290,183,132)
...
Stadiums <- c("Chinnaswamy", "Eden Gardens", "DY Patil")
